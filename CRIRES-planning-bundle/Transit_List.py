...
if k == 1:
    ...
    ETC_calculator = misc.ask_for_value(msg='Do you want to call the ETC calculator to process the results S/N ratio? (WARNING : Only works if you have a working VPN to ESO server!) y/n ')
